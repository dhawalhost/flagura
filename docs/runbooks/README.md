...
| **Data Loss / Database Corruption** | **P0** | Restore from latest verified snapshot via `flagura backup restore --file <snapshot>` | [Disaster Recovery Runbook](disaster-recovery.md#2-restoration-procedure) |
...
3. **[Disaster Recovery & Hot Backups](disaster-recovery.md)**
   - Atomic Snapshot Exports (`.json` and `.json.gz`)
   - Reverse-Chronological Cryptographic Audit Chain Restoration
   - Hot SQLite Database File Copy (`0600` permissions)
   - Production Kubernetes CronJob Backup Manifest
   - Measurable RTO (< 15 min) and RPO (< 1 hour) Recovery Drills

4. **[Database Operations](database-operations.md)**
...
5. **[Security, Access & Credential Management](security-and-access.md)**
...
6. **[SDK Release & Publishing Procedures](sdk-publishing.md)**
...
7. **[Supabase & Vercel Cloud Integration Guide](../integrations/supabase-vercel-setup.md)**
